...
class RemoveSignViewQuery(Query):
...
class RemoveSignViewSession(object):
    ...
    def parse_query(self, data):
        self._query = RemoveSignViewQuery()
        self._query.parse(data)

    def execute(self):
        self._signs_engine.remove_sign_view(self._query.user_id, self._query.sign_id)
        self._users_engine.remove_view(self._query.user_id, self._query.sign_id)
...
if __name__ == "__main__":
    ...
    s = RemoveSignViewSession(global_context)
