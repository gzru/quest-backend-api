...
class GetUserLikesSession(object):
    ...
    def parse_query(self, data):
        self._query = GetUserLikesQuery()
        self._query.parse(data)

    def execute(self):
        page = self._users_engine.get_likes(self._query.user_id, self._query.limit, self._query.cursor)
