...
class AddSignLikeSession(object):
    ...
    def parse_query(self, data):
        self._query = AddSignLikeQuery()
        self._query.parse(data)

    def execute(self):
        self._signs_engine.add_sign_like(self._query.user_id, self._query.sign_id)
        self._users_engine.put_like(self._query.user_id, self._query.sign_id)
