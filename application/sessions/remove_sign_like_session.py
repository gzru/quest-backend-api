...
class RemoveSignLikeSession(POSTSession):
    ...
    def _run_session(self):
        ...
        self._signs_engine.remove_sign_like(self._params.user_token.user_id, self._params.sign_id)
        self._users_engine.remove_like(self._params.user_token.user_id, self._params.sign_id)
