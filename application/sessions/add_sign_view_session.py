...
class AddSignViewSession(POSTSession):
    ...
    def _run_session(self):
        ...
        self._signs_engine.add_sign_view(self._params.user_token.user_id, self._params.sign_id)
        self._users_engine.put_view(self._params.user_token.user_id, self._params.sign_id)
