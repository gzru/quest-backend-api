...
class AddSignViewSession(object):
    ...
    def parse_query(self, data):
        self._query = AddSignViewQuery()
        self._query.parse(data)

    def execute(self):
        self._signs_engine.add_sign_view(self._query.user_id, self._query.sign_id)
        self._users_engine.put_view(self._query.user_id, self._query.sign_id)
...
if __name__ == "__main__":
    ...
    s = AddSignViewSession(global_context)
